    ...
    */
    ...
    function removeMouseWheelHandler() {
      if (doc.addEventListener) {
        docRemoveEvent('mousewheel', MouseWheelHandler, { passive: false }); //IE9, Chrome, Safari, Oper

        docRemoveEvent('wheel', MouseWheelHandler, { passive: false }); //Firefox

        docRemoveEvent('MozMousePixelScroll', MouseWheelHandler, { passive: false }); //old Firefox
      } else {
        // @ts-ignore
